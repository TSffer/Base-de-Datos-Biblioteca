...
EE = form.getfirst('delete','empty')

if(EE!='empty'):
    seleccion = db.cursor()
    seleccion.execute("select usuario_Id,nombres from usuario where nombres like '%s'" % (EE))
    resultadoU = seleccion.fetchall()
    u_id = resultadoU[0][0]
    delete = db.cursor()
    delete.execute("delete from prestamo where usuario_Id = '%s'" % (u_id))
    db.commit()
    delete.execute("delete from reservar where usuario_Id = '%s'" % (u_id))
    db.commit()
    delete.execute("delete from usuario where usuario_Id ='%s'" % (u_id))
    db.commit()
    delete.close()
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="student.py">Usuarios</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la seccion donde se encuentra el listado de estudiantes de la institucion, podras buscar los estudiantes por seccion o nombre. Puedes actualizar o eliminar los datos del estudiante.<br>
                    <strong class="text-danger"><i class="zmdi zmdi-alert-triangle"></i> &nbsp; Importante! </strong>Si eliminas el estudiante del sistema se borraran todos los datos relacionados con el, incluyendo prestamos y registros en la bitacora.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="usuarios.py">Nuevo Usuario</a></li>
        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            ...
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar estudiante" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
                    <button class="btn" name = "eli" style="margin: 0; height: 43px; background-color: transparent !important;">
            ...
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
                <div class="group-material">
                    <input type="search" name = "delete" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Eliminar estudiante" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 18%;">Seccion</div>
...
cursor = db.cursor()
sql="select dni,apellidos,nombres,correo,usuario_id from usuario"
cursor.execute(sql)
...
for i in resultado:
    ...
    print("""</div>
                        <div class="div-table-cell" style="width: 9%;">
                            <button  class="btn btn-success"><a href="liststusuarios.py">Refresh</a><i class="zmdi zmdi-refresh"></i></button>
                        </div>
                        <div class="div-table-cell" style="width: 9%;">
                            <button id="button" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button>""")
    print("""           </div>
                    </div>
                </div>
            </div>""")
