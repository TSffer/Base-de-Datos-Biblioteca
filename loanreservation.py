    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li><a href="loanpending.py">Devoluciones pendientes</a></li>
                <li class="active"><a href="loanreservation.py">Reservaciones</a></li>
            </ul>
        </div>
         <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta seccion, aqui se muestran las reservaciones de libros hechas por los docentes y estudiantes, las cuales estan pendientes para ser aprobadas por ti
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            <form class="pull-right" style="width: 30% !important;" autocomplete="off">
                <div class="group-material">
                    <input type="search" name = "delete" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Eliminar Reserva" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
            ...
            <div class="table-responsive">
                <div class="div-table" style="margin:0 !important;">
                    <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                        ...
                        <div class="div-table-cell" style="width: 10%;">Apellidos</div>
...
cursor = db.cursor()
sql = "select  titulo,nombres,apellidos,fecha from usuario join reservar join recurso on usuario.usuario_Id = reservar.usuario_Id and recurso.recurso_Id = reservar.recurso_Id"
cursor.execute(sql)
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="zmdi zmdi-check zmdi-hc-fw"></i>&nbsp; 2017 Grupo BD <i class="zmdi zmdi-facebook zmdi-hc-fw footer-social"></i><i class="zmdi zmdi-twitter zmdi-hc-fw footer-social"></i></li>
                        </ul>
                    </div>
                </div>
            </div>
