...
fechaP = form.getfirst('Pfecha','empty')
fechaD = form.getfirst('Dfecha','empty')
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema bibliotecario <small>Administracion de Prestamos</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la seccion para registrar los prestamos, para poder registrar un prestamo debe de llenarse todos los campos del siguiente formulario
                </div>
            </div>
        </div>""")
if(len(resultado) ==0):
    ...
    a = 10
    cursor2 = db.cursor()
    cursor2.execute("insert into prestamo values(null,'%s','%s','%s','%s','%s')" % (in_1,in_2,fechaP,fechaD,10))
    db.commit()    
    cursor1.close()
    cursor2.close()
...
print("""
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Registrar Prestamo</li>
                      <li><a href="loan.py">Listado de Prestamos</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Registrar un nuevo Prestamo</div>
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <br><br>
                            ...
                            <div class="group-material">
                                <input type="date" name = "Pfecha" class="material-control tooltips-general" placeholder="Escribe aqui la fecha de Prestamo" required=""  maxlength="50" data-toggle="tooltip" data-placement="top" title="Fecha de Prestamo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                <input type="date" name = "Dfecha" class="material-control tooltips-general" placeholder="Escribe aqui la fecha de Devolucion" required=""  maxlength="50" data-toggle="tooltip" data-placement="top" title="Fecha de Devolucion">
                                <span class="highlight"></span>
                                <span class="bar"></span>
