    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li class="active"><a href="loan.py">Todos los prestamos</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a esta seccion, aqui se muestran todos los prestamos de libros realizados hasta la fecha y que ya se entregaron satisfactoriamente
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Listado de prestamos</h2>
...
cursor = db.cursor()
sql = "select  titulo,nombres,apellidos,fecha_Desde,fecha_Hasta from usuario join prestamo join recurso on usuario.usuario_Id = prestamo.usuario_Id and recurso.recurso_Id = prestamo.recurso_Id"
cursor.execute(sql)
